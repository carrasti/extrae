...
class Model extends Backbone.Model
  ...
  @addFieldDefinition: (fieldName, field) ->
    ThisClass = @::constructor
    if ThisClass::fieldDefinitions == \
                              ThisClass.__super__.constructor::fieldDefinitions
  ...
  ###
  Overrides the default toJSON method serializing also nested models and
    collections
  ...
  extractData: (scraper, $root, options) ->
    ...
    for fieldKey, fieldItem of @fieldDefinitions
      ...
      # corresponding class instance
        ...
        $selectedItems = if fieldItem.selector? \
                                then $root.find fieldItem.selector else $root
